...
export const SETTINGS: SettingDef[] = [
  ...
  { path: "meeting_detection.auto_stop_grace_sec", category: "automation", label: "Auto-stop grace (s)", type: "number", validate: z.number().min(0), reload: R.restart("detector"), advanced: true },
